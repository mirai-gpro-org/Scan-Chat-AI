...
| 関連文書 | `docs/architecture/data_integration_requirements.md` / `docs/architecture/diagnostic_session_data_spec.md` / `docs/scan/scan_feature_requirements.md` |
...
詳細は `docs/architecture/diagnostic_session_data_spec.md` を参照。
...
- 認証・ユーザー単位の連携: `docs/architecture/data_integration_requirements.md`
- 検査セッション・成果物のデータ仕様: `docs/architecture/diagnostic_session_data_spec.md`
- スキャン機能の機能要件: `docs/scan/scan_feature_requirements.md`
- デバイス・認証要件: `docs/architecture/device_and_auth_requirements.md`
